...
- [public/main.html:1-1128](file://public/main.html#L1-L1128)
...
- **文件处理**: 支持拖拽和点击两种文件选择方式
- **Base64编码**: 将文件转换为Base64格式进行前端处理
- **实时预览**: 支持图片文件的缩略图预览
- **批量操作**: 支持多文件同时上传和管理
- **进度反馈**: 实现了模拟的上传进度和状态显示

**章节来源**
- [server.js:92-109](file://server.js#L92-L109)
- [public/main.html:721-734](file://public/main.html#L721-L734)
- [public/main.html:188-279](file://public/main.html#L188-L279)
- [public/main.html:917-946](file://public/main.html#L917-L946)
